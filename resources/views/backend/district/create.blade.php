                     ...
                     <div class="card-block">
                        <form action="{{$data->sAction}}" method="post">
                            ...
                            <div class="form-group row">
                              ...
                              <div class="col-sm-10">
                                 <input type="text" class="form-control" name="district_name" placeholder="Enter district name" value="@isset($record){{$record->district_name}}@else{{old('district_name')}}@endif" required>
                              </div>
                                @error('district_name') 

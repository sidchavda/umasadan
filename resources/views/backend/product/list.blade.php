                                ...
                                <table id="simpletable" class="table table-striped table-bordered nowrap">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            &nbsp;
                                            <a href="{{route('admin.product.destroy',['product' => $value->id])}}"  onclick="deleteRow(event)"><i class="fa fa-trash deleteClass" aria-hidden="true"></i></a>
                                            <form id="delete-form" action="{{route('admin.product.destroy',['product' => $value->id])}}" method="POST" class="d-none"> 
                                                @csrf

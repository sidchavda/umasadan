               ...
               <div class="col-sm-12">
                  <div class="card">
                     ...
                     <div class="card-header"> 
                       ...
                       @isset($record->getAddress->getDistrict->district_name) 
                       {{ucfirst($record->getAddress->getDistrict->district_name)}},
                        {{ucfirst($record->getAddress->getCity->city_name)}},
                        {{ucfirst($record->getAddress->pr_address->pincode)}},@endisset
                        @endif</h5><br><br>
                        ...
                        @isset($record->getAddress->getDistrict->district_name){{ucfirst($record->getAddress->getDistrict->district_name)}},
                        {{ucfirst($record->getAddress->getCity->city_name)}},
                        {{ucfirst($record->getAddress->pr_address->pincode)}},@endisset
                        @endif</h5>
